...
export const AAA_ChallengeCard: React.FC<AAA_ChallengeCardProps> = ({
  ...
  const variantConfig = {
    compact: {
      container: 'w-full max-w-72 h-44',
      padding: 'p-3',
      titleSize: 'text-base',
      imageHeight: 'h-20'
    },
    default: {
      container: 'w-full max-w-80 h-60',
      padding: 'p-4',
      titleSize: 'text-lg',
      imageHeight: 'h-28'
    },
    featured: {
      container: 'w-full h-68',
      padding: 'p-6',
      titleSize: 'text-xl',
      imageHeight: 'h-32'
    },
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="flex items-center gap-1">
              ...
              >
                ...
                <span className="text-xs font-medium text-cyan-300 capitalize">{challenge.type}</span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
              ...
              >
                ...
                <span className="text-xs font-medium text-purple-300 capitalize">{challenge.category}</span>
              </motion.div>
            </div>
