...
export const mockBettingChallenges: BettingChallenge[] = [
  {
    ...
    category: 'food',
    difficulty: 'hard',
    startTime: new Date('2025-08-15T08:00:00'),
    endTime: new Date('2025-08-15T09:00:00'),
    participants: [
      {
        id: 'p1',
        name: 'Alex Chen',
        ...
        betAmount: 25,
        joinedAt: new Date('2025-08-14T10:30:00')
      },
      {
        id: 'p2',
        name: 'Maria Garcia',
        ...
        betAmount: 15,
        joinedAt: new Date('2025-08-14T11:15:00')
      },
      {
        id: 'p3',
        name: 'John Smith',
        ...
        betAmount: 30,
        joinedAt: new Date('2025-08-14T12:00:00')
      },
      {
        id: 'p4',
        name: 'Emma Wilson',
        ...
        betAmount: 20,
        joinedAt: new Date('2025-08-14T13:45:00')
      },
      {
        id: 'p5',
        name: 'David Kim',
        ...
        betAmount: 18,
        joinedAt: new Date('2025-08-14T14:20:00')
      },
      {
        id: 'p6',
        name: 'Lisa Park',
        ...
        betAmount: 22,
        joinedAt: new Date('2025-08-14T15:10:00')
      }
    ],
    totalPool: 130,
    yesBets: 4,
  ...
  },
  {
    ...
    category: 'coding',
    difficulty: 'medium',
    startTime: new Date('2025-08-20T14:00:00'),
    ...
    participants: [
      {
        ...
        avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face',
        betAmount: 40,
        joinedAt: new Date('2025-08-19T09:20:00')
      },
      {
        id: 'p6',
        name: 'Lisa Park',
        avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face',
        betAmount: 25,
        joinedAt: new Date('2025-08-19T10:15:00')
      },
      {
        id: 'p7',
        name: 'Rachel Green',
        ...
        betAmount: 35,
        joinedAt: new Date('2025-08-19T11:30:00')
      },
      {
        id: 'p8',
        name: 'Chris Johnson',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face',
        betAmount: 20,
        joinedAt: new Date('2025-08-19T12:45:00')
      }
    ],
    totalPool: 120,
    yesBets: 2,
  ...
  },
  {
    ...
    category: 'fitness',
    difficulty: 'expert',
    startTime: new Date('2025-08-25T07:00:00'),
    endTime: new Date('2025-08-25T08:00:00'),
    participants: [
      {
        id: 'p7',
        name: 'Rachel Green',
        avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=80&h=80&fit=crop&crop=face',
        betAmount: 35,
        joinedAt: new Date('2025-08-24T08:30:00')
      },
      {
        id: 'p8',
        name: 'Chris Johnson',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face',
        betAmount: 20,
        joinedAt: new Date('2025-08-24T09:45:00')
      },
      {
        id: 'p9',
        name: 'Sophie Brown',
        avatar: 'https://images.unsplash.com/photo-1494790108755-2616b60ad193?w=80&h=80&fit=crop&crop=face',
        betAmount: 15,
        joinedAt: new Date('2025-08-24T11:20:00')
      },
      {
        id: 'p10',
        name: 'Kevin Lee',
        avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face',
        betAmount: 28,
        joinedAt: new Date('2025-08-24T13:15:00')
      },
      {
        id: 'p11',
        name: 'Amanda White',
        avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face',
        betAmount: 32,
        joinedAt: new Date('2025-08-24T14:30:00')
      }
    ],
    totalPool: 130,
    yesBets: 3,
    ...
    participants: [
      {
        ...
        avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face',
        betAmount: 50,
        joinedAt: new Date('2025-09-04T14:15:00')
      },
      {
        id: 'p11',
        name: 'Amanda White',
        avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&h=80&fit=crop&crop=face',
        betAmount: 30,
        joinedAt: new Date('2025-09-04T15:30:00')
      },
      {
        id: 'p12',
        name: 'Tyler Durden',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face',
        betAmount: 45,
        joinedAt: new Date('2025-09-04T16:45:00')
      },
      {
        id: 'p13',
        name: 'Nina Patel',
        avatar: 'https://images.unsplash.com/photo-1494790108755-2616b60ad193?w=80&h=80&fit=crop&crop=face',
        betAmount: 25,
        joinedAt: new Date('2025-09-04T17:20:00')
      }
    ],
    totalPool: 150,
    yesBets: 2,
  ...
  },
  {
    ...
    category: 'gaming',
    difficulty: 'expert',
    startTime: new Date('2025-09-10T18:00:00'),
    endTime: new Date('2025-09-10T22:00:00'),
    participants: [
      {
        id: 'p12',
        name: 'Tyler Durden',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face',
        betAmount: 45,
        joinedAt: new Date('2025-09-09T20:00:00')
      },
      {
        id: 'p13',
        name: 'Nina Patel',
        avatar: 'https://images.unsplash.com/photo-1494790108755-2616b60ad193?w=80&h=80&fit=crop&crop=face',
        betAmount: 25,
        joinedAt: new Date('2025-09-09T21:15:00')
      },
      {
        id: 'p14',
        ...
        avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=face',
        betAmount: 35,
        joinedAt: new Date('2025-09-09T22:30:00')
      },
      {
        id: 'p15',
        name: 'Sarah Chen',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=80&h=80&fit=crop&crop=face',
        betAmount: 40,
        joinedAt: new Date('2025-09-10T09:00:00')
      },
      {
        id: 'p16',
        name: 'Mike Wilson',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&h=80&fit=crop&crop=face',
        betAmount: 30,
        joinedAt: new Date('2025-09-10T10:30:00')
      }
    ],
    totalPool: 175,
    yesBets: 2,
